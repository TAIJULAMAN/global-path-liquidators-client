...
const PalletDealsSection = () => {
    ...
    const palletDealsProducts = palletDealsAll?.result;
    ...
    return (
        <div className="nc-SectionGridFeatureItems relative">
            <Heading desc="Discover the most trending products.">Pallet Deals</Heading>
            <div
                className={`grid gap-8 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 `}
            >
                {palletDealsProducts?.slice(0, 8).map((item: any, index: any) => (
                    <div
            ...
            <div className="flex mt-16 justify-center items-center">
                <ButtonPrimary
                    onClick={() => navigate("/pallet-page")}>Show me more</ButtonPrimary>
            </div>
        </div>
    );
};

export default PalletDealsSection;