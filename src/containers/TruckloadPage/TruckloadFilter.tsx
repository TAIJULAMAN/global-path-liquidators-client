...
const TruckloadFilter = ({ className = "" }) => {
  // all states
            ...
            >
              <Popover.Panel className="absolute z-40 w-screen max-w-sm px-4 mt-3 left-0 sm:px-0 lg:max-w-sm">
                <div className="overflow-hidden rounded-2xl shadow-xl bg-white dark:bg-neutral-900 border border-neutral-200 dark:border-neutral-700">
                  ...
                  <div className="p-5 bg-slate-50 dark:bg-slate-900 dark:border-t dark:border-slate-800 flex items-end justify-end">
                    <ButtonThird
                      onClick={() => {
                        close();
                        setManifestState([]);
    ...
    >
      ...
      <div className="">
        <div className="space-y-2 lg:space-y-14">
          <main>
            <h1 className="text-center font-semibold mb-4 text-2xl">Truckload Products</h1>
...
export default TruckloadFilter;
