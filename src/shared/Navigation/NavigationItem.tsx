      ...
      <NavLink
        ...
        className={({ isActive }) =>
          `flex items-center py-2 px-4 rounded-md hover:text-neutral-700 hover:bg-neutral-100 dark:hover:bg-neutral-800 dark:hover:text-neutral-200 ${
            isActive
              ? "font-medium text-neutral-900 dark:text-green-600"
    ...
    return (
      <div className="h-20 flex-shrink-0 flex items-center">
        <NavLink
          target={item.targetBlank ? "_blank" : undefined}
          rel="noopener noreferrer"
          className={`inline-flex items-center text-sm lg:text-[15px] mx-1 font-medium text-slate-700 dark:text-slate-300 py-2.5 px-3 2xl:px-4 rounded-full hover:text-slate-900 hover:bg-slate-200  dark:hover:bg-slate-800 dark:hover:text-slate-200 hover:border-b-2  ${
            path === `${item.href}` && "bg-slate-200 dark:text-slate-700"
          }`}
          to={{
            pathname: item.href || undefined,
          }}
