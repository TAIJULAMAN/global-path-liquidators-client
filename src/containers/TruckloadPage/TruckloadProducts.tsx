...
import { useGetAllTruckloadsQuery } from "features/api/truckloadApi";
...
// const TruckloadProducts = () => {
const TruckloadProducts: React.FC<TruckloadProps> = ({
  categoriesState,
  ...
  const { data: truckload, isLoading } = useGetAllTruckloadsQuery(queries, {
    refetchOnMountOrArgChange: true,
  });
  const metaData = truckload?.meta;

  const metaPage = metaData?.page;
  // const { data: truckload, isLoading } = useGetAllTruckloadsQuery(undefined);
            ...
            >
              ...
              <div className="space-y-4 px-3 pt-5 pb-2.5">
                <div className="flex justify-between items-start w-full ">
                  ...
                  <Prices price={item?.truckload_price} />
                </div>
...
export default TruckloadProducts;
